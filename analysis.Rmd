...
source("C:\\Users\\pylell\\Documents\\GitHub\\ASKEDIT\\ASKEDIT_R_2019-01-16_1449.r")
smod <- data
# keep only the score variables
#smod <- smod[,c("pid","redcap_event_name","care_subscale","problem_solve_score","communication_score",     
#                "goal_score","smod_score")]
...
tab2 <- final_table(data,c("d.mwikad3","d.mwikad6","d.a1c3","d.a1c6","d.bgtest3","d.bgtest6","d.high3","d.high6",
                           "d.low3","d.low6","d.inrange3","d.inrange6","d.smod3","d.smod6")
                    ,group=as.factor(data$redcap_event_name.factor),margin=2,single=0,ron=1)
