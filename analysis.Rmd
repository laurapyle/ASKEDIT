...
source("K:\\BDC Github\\General-code\\01_functions.r")
...
tab2b <- final_table(data,c("mwikadenroll","mwikad3month","mwikad6month",
...
tab_ltfu <- final_table(data,c("mwikadenroll","mwikad3month","mwikad6month",
                            "collaboration_score.0","collaboration_score.3","collaboration_score.6",
                            "care_subscale.0","care_subscale.3","care_subscale.6",
                            "problem_solve_score.0","problem_solve_score.3","problem_solve_score.6",
                            "communication_score.0","communication_score.3","communication_score.6",
...
```{r, results='asis',tidy=TRUE, echo=FALSE}
kable(tab2,caption="Table 2.  Changes in study outcomes by group.  Statistics given are N(%), mean±SD, or median (25th %ile, 75th %ile).  * denotes that the Mannn-Whitney test was used, and ** denotes that Fisher's exact test was used.")
```
\
